...
- **key** is `0x04`-prefixed (`NodeId`, `U32`, `String`) pair. String is a user-defined text used by the map operators
  of `Node` API. `U32` is big-endian XX hash of that string.
